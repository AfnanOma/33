...
let correctWords = [ 'فجل','كوسا', 'فلفل', 'ثوم', 'بصل','جزر' ,'خيار'];
...
function populateImageBox() {
    ...
    const orderOfImages = [ 1,23,23,24,10,10,12,20,5,27,9,1,27,23,20,24,5,28,22,20,23,14,2,7];
